...
namespace ZhiBan
{
    class BeginFunc_AutoCut
    {
        //单块重构--1月更新版
        public static bool _init_(DataTable data_xy, DataTable data_para, point start, point end, double dam_rate, ref string para_output_message)
        {
            try
            {
