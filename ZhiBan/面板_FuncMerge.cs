...
namespace ZhiBan
{
    class 面板_FuncMerge
    {
        public static bool merge_dam(point[] merge_before1, point[] merge_before2, point[] merge_after1, point[] merge_after2, ref ArrayList points_list)
        {
            try
            {
                //XZT
                //QT延长线原则上相交
                point merge_x = new point(0, 0, 0);
                common_xoy(merge_before1[0], merge_before2[0], merge_after1[0], merge_after2[0], ref merge_x);
                Log.write_log("D://test.txt", "merge_before1_x:" + merge_before1[0].x.ToString() + " * " + merge_before1[0].y.ToString() + " * " + merge_before1[0].z.ToString() + "\r\n");
                Log.write_log("D://test.txt", "merge_before2_x:" + merge_before2[0].x.ToString() + " * " + merge_before2[0].y.ToString() + " * " + merge_before2[0].z.ToString() + "\r\n");
                Log.write_log("D://test.txt", "merge_after1_x:" + merge_after1[0].x.ToString() + " * " + merge_after1[0].y.ToString() + " * " + merge_after1[0].z.ToString() + "\r\n");
                Log.write_log("D://test.txt", "merge_after2_x:" + merge_after2[0].x.ToString() + " * " + merge_after2[0].y.ToString() + " * " + merge_after2[0].z.ToString() + "\r\n");
                //double[] dir1 = new double[3] { merge_before2[0].x - merge_before1[0].x, merge_before2[0].y - merge_before1[0].y, merge_before2[0].z - merge_before1[0].z };
                //double[] dir2 = new double[3] { merge_after2[0].x - merge_after1[0].x, merge_after2[0].y - merge_after1[0].y, merge_after2[0].z - merge_after1[0].z };

                double[] dir_before = new double[3] { merge_x.x - merge_before2[0].x, merge_x.y - merge_before2[0].y, merge_x.z - merge_before2[0].z };
                point pz1 = new point(merge_before2[1].x + dir_before[0], merge_before2[1].y + dir_before[1], merge_before2[1].z + dir_before[2]);
                point pt1 = new point(merge_before2[2].x + dir_before[0], merge_before2[2].y + dir_before[1], merge_before2[2].z + dir_before[2]);

                double[] dir_after = new double[3] { merge_x.x - merge_after2[0].x, merge_x.y - merge_after2[0].y, merge_x.z - merge_after2[0].z };
                point pz2 = new point(merge_after2[1].x + dir_after[0], merge_after2[1].y + dir_after[1], merge_after2[1].z + dir_after[2]);
                point pt2 = new point(merge_after2[2].x + dir_after[0], merge_after2[2].y + dir_after[1], merge_after2[2].z + dir_after[2]);


                points_list.Clear();
                Log.write_log("D://test.txt", "merge_x:" +  merge_x.x.ToString() + " * " + merge_x.y.ToString() + " * " + merge_x.z.ToString() + "\r\n");
                points_list.Add(pz1);
                Log.write_log("D://test.txt", pz1.x.ToString() + " * " + pz1.y.ToString() + " * " + pz1.z.ToString() + "\r\n");
                points_list.Add(pt1);
                Log.write_log("D://test.txt", pt1.x.ToString() + " * " + pt1.y.ToString() + " * " + pt1.z.ToString() + "\r\n");
                points_list.Add(pz2);
                Log.write_log("D://test.txt", pz2.x.ToString() + " * " + pz2.y.ToString() + " * " + pz2.z.ToString() + "\r\n");
                points_list.Add(pt2);
                Log.write_log("D://test.txt", pt2.x.ToString() + " * " + pt2.y.ToString() + " * " + pt2.z.ToString() + "\r\n");
                return true;
            }
            catch (Exception ex)
            {
        ...
        public static bool merge_dam(point line_s, point line_e, point[] merge_before1, point[] merge_before2, point[] merge_after1, point[] merge_after2, ref ArrayList points_list)
        {
            try
            {
                ...
                merge_main_precise(merge_before1, merge_before2, merge_after1, merge_after2, vec_dam, base_p, ref merge_res1, ref merge_res2);
